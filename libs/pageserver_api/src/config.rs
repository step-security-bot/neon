...
pub struct TenantConfigToml {
    ...
    /// Level0 delta layer threshold at which to stall layer flushes. If None, defaults to
    /// 4 * compaction_threshold. Must be >compaction_threshold to avoid compaction deadlock.
...
impl Default for TenantConfigToml {
    fn default() -> Self {
        ...
        Self {
            ...
            compaction_flush_delay_threshold: None,
            compaction_flush_stall_threshold: None,
