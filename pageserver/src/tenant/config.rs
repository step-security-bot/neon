    ...
    pub fn merge(&self, global_conf: TenantConf) -> TenantConf {
        TenantConf {
            ...
            compaction_algorithm: self
                ...
                .clone(),
            compaction_flush_delay_threshold: self
                .compaction_flush_delay_threshold
                .or(global_conf.compaction_flush_delay_threshold),
            compaction_flush_stall_threshold: self
                .compaction_flush_stall_threshold
                .or(global_conf.compaction_flush_stall_threshold),
...
impl From<TenantConfOpt> for models::TenantConfig {
    fn from(value: TenantConfOpt) -> Self {
        ...
        Self {
            ...
            compaction_flush_delay_threshold: value.compaction_flush_delay_threshold,
            compaction_flush_stall_threshold: value.compaction_flush_stall_threshold,
